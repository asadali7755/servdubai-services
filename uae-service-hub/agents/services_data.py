"""
Shared service-topic list used by all content/blog agents.
Single source of truth so run_agents.py, blog_agent_qa.py and
blog_agent_trending.py never drift out of sync.
"""
